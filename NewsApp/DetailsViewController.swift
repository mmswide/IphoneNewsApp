...
class DetailsViewController: UIViewController , UIScrollViewDelegate {
    ...
    {
        let savedArticles = TheGuardianAPI.loadSavedArticles()
    ...
    func setupView()
    {
        ...
        let activityIndicator = UIActivityIndicatorView(frame: CGRect(x: screenWidth*0.45, y: screenHeight*0.2 + 10, width: 20, height: 20))
        activityIndicator.color = UIColor.grayColor()
        activityIndicator.startAnimating()
        scrollView.addSubview(activityIndicator)
        
        let imageView = UIImageView(frame: CGRect(x: 0, y: 0, width: screenWidth, height: screenHeight * 0.4))
        ...
        let label = UILabel(frame: CGRect(x: 8, y: screenHeight*0.4 + 8, width: screenWidth - 16, height: screenHeight*0.2))
        ...
        let textView = UITextView(frame: CGRect(x: 8, y: height, width: screenWidth - 16, height: screenHeight*100))
